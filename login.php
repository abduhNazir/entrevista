...
if($_POST){
	...
	if($_POST["email"] == "example@example.com" && $_POST["senha"] == "123"){
	
		$_SESSION["usuario"] = $_POST["email"];
		header("Location: index.php");
		exit;
	}else{
		$mensagem = "Raaaaam Usuario Inválido. Tem certeza que sabe o que esta fazendo!";
	}
}
	  	...
	  	<div class="container">
		      ...
		      <form class="form-login" action="<?php echo $_SERVER["PHP_SELF"]?>" method="post">
		        ...
		        <?php
			  		if(!empty($mensagem)){
			  			?>
			  			<p class="alert" align="center"> <?php echo $mensagem ?> </p>
			  			<?php
			  		}
			  		?>  
